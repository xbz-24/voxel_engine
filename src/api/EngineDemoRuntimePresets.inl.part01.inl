			...
			ve::rendering::VulkanMinecraftDemoPreset preset) noexcept
		{
			...
			case ve::rendering::VulkanMinecraftDemoPreset::AquaModel:
				return style
					...
					.WithAmbientOcclusion(0.72f)
					.WithAerialPerspective(1.22f)
					.WithSubsurfaceScattering(1.16f)
					.WithCloudLightAbsorption(0.76f)
					.WithDirectionalShadows(0.72f, 1.35f, 190.0f);
			case ve::rendering::VulkanMinecraftDemoPreset::SponzaAtrium:
				return style
					...
					.WithAmbientOcclusion(1.34f)
					.WithAerialPerspective(0.82f)
					.WithSubsurfaceScattering(0.68f)
					.WithCloudLightAbsorption(1.14f)
					.WithDirectionalShadows(1.15f, 0.85f, 180.0f);
			case ve::rendering::VulkanMinecraftDemoPreset::HyperrealDesert:
			default:
				return style
					.WithAmbientOcclusion(1.08f)
					.WithAerialPerspective(1.12f)
					.WithSubsurfaceScattering(0.78f)
					.WithCloudLightAbsorption(1.18f)
					.WithDirectionalShadows(0.92f, 1.10f, 260.0f);
			}
		}
