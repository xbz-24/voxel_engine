...
#define VE_LOG_CATEGORY_TRACE(category, message) ::ve::log::Write(::ve::log::Level::Trace, (category), (message), { __FILE__, __FUNCTION__, __LINE__ })
#define VE_LOG_CATEGORY_DEBUG(category, message) ::ve::log::Write(::ve::log::Level::Debug, (category), (message), { __FILE__, __FUNCTION__, __LINE__ })
...
#define VE_LOG_CATEGORY_WARNING(category, message) ::ve::log::Write(::ve::log::Level::Warning, (category), (message), { __FILE__, __FUNCTION__, __LINE__ })
