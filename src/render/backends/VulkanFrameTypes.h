...
namespace ve::rendering
{
	...
	struct VulkanSoftwareRasterizerSettings
	{
	...
	struct VulkanSoftwareVoxelRasterizerFrame
	{
		VulkanSoftwareVoxelRasterizerFrame(const ve::world::World& frame_world,
			...
			const VulkanFrameInput& frame_input,
			VulkanSoftwareRasterizerSettings& frame_settings) noexcept;
		...
		VulkanSoftwareRasterizerSettings& settings;
	};
}
