...
if (VE_BUILD_TESTS)
    set(VE_INSTALLED_SDK_TOOLCHAIN_FILE "${CMAKE_TOOLCHAIN_FILE}")
    if (NOT EXISTS "${VE_INSTALLED_SDK_TOOLCHAIN_FILE}" AND
            DEFINED Z_VCPKG_ROOT_DIR)
        set(VE_INSTALLED_SDK_TOOLCHAIN_FILE
            "${Z_VCPKG_ROOT_DIR}/scripts/buildsystems/vcpkg.cmake")
    endif()
    ...
    add_test(NAME installed_sdk_package
        COMMAND "${CMAKE_COMMAND}"
            ...
            "-DVE_GENERATOR_TOOLSET=${CMAKE_GENERATOR_TOOLSET}"
            "-DVE_MULTI_CONFIG=$<BOOL:${CMAKE_CONFIGURATION_TYPES}>"
            "-DVE_CMAKE_TOOLCHAIN_FILE=${VE_INSTALLED_SDK_TOOLCHAIN_FILE}"
